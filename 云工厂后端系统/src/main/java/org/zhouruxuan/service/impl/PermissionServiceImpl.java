...
import org.zhouruxuan.helper.MemuHelper;
import org.zhouruxuan.helper.PermissionHelper;
import org.zhouruxuan.mapper.PermissionMapper;
    ...
    public List<String> selectPermissionValueByUserId(String id) {
        ...
        if(this.isSysAdmin(id)) {
            ...
            for (Permission permission : list) {
                selectPermissionValueList.add(permission.getPermissionValue());
            }
        } else {
